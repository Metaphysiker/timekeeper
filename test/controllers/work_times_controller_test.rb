...
class WorkTimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create work_time" do
    assert_difference('WorkTime.count') do
      post work_times_url, params: { work_time: { minutes: @work_time.minutes, task: @work_time.task } }
    end
  ...
  test "should update work_time" do
    patch work_time_url(@work_time), params: { work_time: { minutes: @work_time.minutes, task: @work_time.task } }
